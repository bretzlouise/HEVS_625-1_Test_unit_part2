...
namespace UnitTests
{
    ...
    public class FileOperationsManagerTest
    {
        ...
        {
            var saveFile = Substitute.For<FileOperations>(); //create a substitute for the interface
            Bitmap beachStored = Properties.Resources.cardBmp;
            saveFile.saveFile(beachStored);
